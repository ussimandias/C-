<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DevSheet6.aspx.cs" Inherits="ASPApplications.DevSheet6" %>
...
<body>
   ...
   <div class="container">
    <div class="jumbotron">
                <h3><span class="auto-style1"><strong>Methods</strong></span><span class="auto-style2"><strong>...</strong></span></h3>
                <hr class="m-y-2" />
           </div>
		    &nbsp;
